        ...
        <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-3xl shadow-lg border border-gray-100">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <strong>Vercel Inc.</strong>, 340 S Lemon Ave #4133, Walnut, CA 91789, USA. Die
              Nutzung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse
              an einer zuverlässigen und schnellen Darstellung).
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              diese erfolgen gemäß § 25 TDDDG. Nicht unbedingt erforderliche Cookies werden nur mit
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO (vorvertragliche Maßnahmen) bzw. Art. 6
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Zudem besteht ein Beschwerderecht bei der zuständigen Aufsichtsbehörde (Art. 77
              DSGVO). Zur Ausübung Ihrer Rechte wenden Sie sich bitte an die im Impressum
