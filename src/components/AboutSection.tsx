...
export default function AboutSection() {
  ...
  // âœ… ZERO-DEFECT: Dynamisch - PrÃ¼ft, ob Hermes in der Config aktiviert ist
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <FadeInWhenVisible direction="up" delay={0.2} duration={0.8}>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
            ...
            {contact.address.zip} {contact.address.city}, in der NÃ¤he des Bahnhofs und weiterer
            lokaler GeschÃ¤fte.
          </p>
        </FadeInWhenVisible>
        ...
        <FadeInWhenVisible direction="up" delay={0.4} duration={0.8}>
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            versenden oder abends noch GetrÃ¤nke fÃ¼r den Feierabend kaufen mÃ¶chten â€“ wir sind
            fÃ¼r Sie da.{' '}
            {hasHermes &&
              'Als offizieller Hermes Paketshop bieten wir Ihnen zusÃ¤tzlich alle Dienstleistungen rund um Paketversand, -abholung und Retouren. '}
