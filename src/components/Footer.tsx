...
export default function Footer() {
  ...
  return (
    // FIX: pb-28 auf Mobile (damit die Action Bar nichts verdeckt), md:pb-12 auf Desktop
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>📱 Handy-Guthaben</li> {/* ✅ FIX: Emoji hinzugefügt */}
              <li>💳 Geld abheben</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400 mb-4">
              ...
              {/* ✅ FIX: Telefonnummer jetzt klickbar für mobile Conversion */}
              <li>
                <a
                  href="tel:+4922359291160"
                  className="hover:text-white transition-colors inline-flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500 rounded px-1"
                >
                  📞 02235 9291160
                </a>
              </li>
            ...
            >
              {/* ✅ FIX: aria-hidden hinzugefügt, damit Screenreader den Pfad nicht vorlesen */}
