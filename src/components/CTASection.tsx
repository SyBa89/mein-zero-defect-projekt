...
export default function CTASection() {
  ...
  return (
    <section className="relative py-20 px-4 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden">
      {/* Hintergrund-Blobs - GPU-composited CSS Animations */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-20 left-1/4 w-64 h-64 bg-pink-200 dark:bg-pink-900/20 rounded-full opacity-20 blur-3xl animate-blob-1"
          style={{ willChange: 'transform' }}
        />
        <div
          className="absolute bottom-20 right-1/4 w-64 h-64 bg-purple-200 dark:bg-purple-900/20 rounded-full opacity-20 blur-3xl animate-blob-2"
          style={{ willChange: 'transform' }}
        />
      </div>
